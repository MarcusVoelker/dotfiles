...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = '/home/nethshady/Genuitec/Eclipse 4.2 for Arcade Development//plugins/org.eclim_2.2.3.22-geb01325'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = '/home/nethshady/Genuitec/Eclipse 4.2 for Arcade Development/'
  if has('win32unix')
